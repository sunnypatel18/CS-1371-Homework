...
function [A B C D E F G H I J K L M N O P Q] = ABCs_strings(str1, str2, vec1, alph1, var1, double1, str3, str4)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 6. ischar()
%    Is var1 a string (character array)? The answer should be a
%    logical true or false. (F)

% 7. sprintf()
%    Use sprintf to create the string: 'alph1 is the letter <alph1>' 
...
%    'alph1 is the letter b' (G)

% 8. strcmp() 
%    Are str1 and str2 the same string? (H)

% 9. strcmpi()
%    Are str1 and str2 the same string if you ignore case? (I)

% 10. class().
%     What is the class of var1? (J)

% 11. What is the datatype of the output of the class function (like J)? 
%     Do not use the class function and write your answer as a string. (K)

% 12. num2str(). 
%     double1 is variable representing a number.  Convert double1 to a
%     string representing that number. For example, if double1 is the
%     number 5683968, you would convert it to the string '5683968'. 
%     (L)

% 13. str2num(). 
%     str3 is a string that represents a number.  Convert str3 to that
%     number using str2num. For example, if str3 is the string '711', you
%     would convert it to the number 711. (M)

% 14. strtok().  
%     str4 is a string with words separated by commas, like so:
%                        'word1,word2,word3'
%     Use strtok to find the first word in the string and store it in (N); 
%     store the rest of the string in (O).

% 15. strtok(). Store the second word in the original string as (P) and 
%     store the rest of the string in (Q).
%     (Hint: you should use the variable (O) and indexing is not
%     necessary)
