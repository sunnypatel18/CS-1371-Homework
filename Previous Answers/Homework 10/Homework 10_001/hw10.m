...
%   an arbitrarily long polynomial and condenses it into the form (x+1)^n,
%   or binomial form. The function should return [1 1] as its first output,
...
%   outlined below involves reversing up Pascal's Triangle. For more
...
%   binomial in the form [1 1]. If it is, it should return from the
%   function. If it is not, the function should step through the polynomial
%   left to right and subtract the previous index from the current index.
%   
%   Example: 
%
...
% Test Cases:
%
%   [vec1 n1] = reversePascal([1 4 6 4 1]);
%       vec1 => [1 1]
%       n1 => 4
%
%   [vec2 n2] = reversePascal([1 7 21 35 35 21 7 1]);
%       vec2 => [1 1]
%       n2 => 7
%
%   [vec3 n3] = reversePascal([1 11 55 165 330 462 462 330 165 55 11 1]);
%       vec3 => [1 1]
%       n3 => 1
%
%   [vec4 n4] = reversePascal([1 1]);
%       vec3 => [1 1]
%       n3 => 1
%
%==========================================================================
...
%   - The title of the plot will be 'The Portal'. 
% Hints:
